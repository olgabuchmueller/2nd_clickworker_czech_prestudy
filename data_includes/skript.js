...
PennController("final",
    ...
    newCanvas("d1",1,40)
        .print()
    ,
    newText("Prosíme, poznamenejte si následující kód: <strong>Jazyk1412</strong><br> Tento kód použijete, abyste získali finanční odměnu přes server Clikworker. Bez tohoto kódu není možné odměnu získat.")
        .settings.color("red")
        .css("font-size", "large")
        .settings.center()
        .print()
    ...
    newCanvas("d3",1,40)
        .print()
    ,
    newText("M&ouml; Zde je místo na Vaše případné připomínky či komentáře. Budeme rádi za Vaši zpětnou vazbu!")
        .settings.center()
        .print()  
    ,
    newCanvas("d4",1,20)
    ...
    newCanvas("d5",1,40)
        .print()
    ,
    newText("Až kliknete na tlačítko POKRAČOVAT, objeví se prázdná stánka se zcela vyplněným pruhem vašeho progresu. Tuto stránku můžete zavřít, Vaše odpovědi jsou již uložené.")
         .settings.center()
        .print()
    ,
    newCanvas("d6",1,40)
